...
class AutoRelist(BaseScript):
    ...
    def run(self, count=1):
        ...
        for _ in range(count):
            ...
            # 画像あり再出品を押下する
            self.click_and_wait(image_path="./images/mercari_copy.png")
            ...
            if edit_page:
                edit_item_button: tuple = self.screen.check_page(image_path="./images/syouhinnnohensyuu.png")
                pgui.click(edit_item_button, duration=0.5)
                self.logger.info("通常の商品編集ボタンを押下しました")
            elif edit_time_sale_page:
                edit_time_sale_button: tuple = self.screen.check_page(image_path="./images/time-sale-or-syouhinnohensyu.png")
            ...
            try:
                # この商品を削除するボタンを押下
                delete_button: tuple = self.screen.check_page(image_path="./images/konosyouhinwosakujosuru.png")
            ...
            try:
                # 削除するボタンを押下
                delete_popup_button: tuple = self.screen.check_page(image_path="./images/sakujosuru.png")
